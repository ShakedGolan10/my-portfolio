...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full flex item-center py-5 px-5 fixed
      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link to='/' className='flex items-center gap-2'
          ...
          <p className='text-white text-[18px] flex 
            font-bold cursor-pointer'>Shaked &nbsp;<span className='sm:block hidden'>| Golan</span></p>
        </Link>
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          <a href={resume} download='Shaked Golan - CV' className='text-secondary hover:text-white text-[18px]
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
            ...
            items-start flex-col gap-4'>
              ...
              <a href={resume} download='Shaked Golan - resume' className='text-secondary hover:text-white text-[18px]
              font-medium cursor-pointer`'>
                CV
              </a>
            </ul>
