  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Enjoy viewing my skills
          and experience through those examples of my work.
          Each project is briefly described with links to code repositories
          and live demos in it.
          You can also see my progress in design patterns, scalble code, usage of new tecnologies, and UI interface.
        </motion.p>
      </div>
